  ...
  <div id="sb-site">
	...
	<div style="background-color:#000" class="parallax-bg" data-bottom-top="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" data-anchor-target="#page-sample">
	  <div class="container">
		...
		<h2 class="title">@pfexpo@</h2>
		<p style="font-size:2.4em;color:white;"> I corsi di questo PFEXPO non sono stati ancora resi pubblici. Garantisciti i primi posti nelle aule con questa preiscrizione.<br> Verrai contattato appena saranno aperte le iscrizioni ufficiali!</p>
									     </div> <!-- .col-md-12 -->
								     </div> <!-- .row -->
							     </div> <!-- .container -->
					      </div> <!-- .parallax-bg -->
	...
	@msg_html;noquote@
	  ...
	  <formtemplate id="iscritto">
	    <fieldset>
	      <legend>Inserisci la tua email e conferma</legend>
	      <div data-row-span="2">
		<div data-field-span="1" class="" style="height: 59px;">
		  <label>Nome e cognome</label>
		  <font color="red">
                    <formerror id="nominativo"></formerror>
	  </font>
                  <input type="text" autofocus="" name="nominativo" maxlenght="100" id="nominativo" style="text-transform:lowercase;">
                                              </div>
		<div data-field-span="1" class="" style="height: 59px;">
		<label>Email *</label>
		<font color="red">
      ...
      <div data-row-span="2">
        <div data-field-span="1" class="" style="height: 59px;">
          ...
          <font color="red">
            <formerror id="cellulare"></formerror>
          </font>
          <input type="text" autofocus="" name="cellulare" maxlenght="100" id="cellulare" style="text-transform:lowercase;">
                                              </div>
