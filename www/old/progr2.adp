  <master>
    ...
    <div class="container">
      ...
      <br>
	<center><img height="100px" width="auto" src="@logo_url;noquote@" /></center>
      </br>      
      @message;noquote@
      <div class="container">
	<br>	
	  @iscrizione_html;noquote@
	  <if @confirm_form;noquote@ ne "">
	    <div class="alert alert-warning">
	      <formtemplate id="register">
		<tr>
		  <td><div class="input-sm col-sm-2"><formwidget id="first_names"></formwidget></div></td>
		  <td><div class="input-sm col-sm-2"><formwidget id="last_name"></formwidget></div></td>
		  <td><div class="input-sm col-sm-2"><formwidget id="email"></formwidget></div></td>
		  <td><div class="input-sm col-sm-2"><formwidget id="societa"></formwidget></div></td>
		  <td><div class="input-sm col-sm-2"><formwidget id="provincia"></formwidget></div></td>
		  <td><div class="input-sm col-sm-2"><formwidget id="privacy"></formwidget></div></td>
		</tr>
		<br></br>
		<strong>Attenzione</strong>: conferma la tua iscrizione agli eventi cliccando quì.
