...
<head>
	...
	<title>Registrazione completata - PFEXPO</title>
  ...
  <div id="sb-site">
	...
	<div style="background-color:" class="parallax-bg" data-bottom-top="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" data-anchor-target="#page-sample">
	  <div class="container">
		...
		<h2 class="title">Grazie per esserti iscritto al PFEXPO!</h2>
		<p class="subtitle">L'iscrizione è andata a buon fine, a breve le  arriverà un'email di conferma. Ti consigliamo di controllare anche la casella di <b>SPAM</b></p>
											     </div> <!-- .col-md-12 -->
								     </div> <!-- .row -->
							     </div> <!-- .container -->
						     </div> <!-- .parallax-bg -->
