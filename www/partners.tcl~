...
db_foreach query "select partner_id, denominazione, permalink, immagine from expo_partners where visibile is true order by denominazione" {
    append html "<div class=\"col-lg-4\"><center><a href=\"partners/$permalink\"><img class=\"center-block\" src=\"http://images.professionefinanza.com/pfexpo/partners_portraits/$immagine\" alt=\"$denominazione\" width=\"200px\" height=\"200px\"><!--<h3>$denominazione</h3>--></a></center></div>"
}
append html "</div>"
