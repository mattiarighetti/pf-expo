  ...
  <div class="col-md-2">
    ...
    <div class="jumbotron">
      <h2 style="text-align:center;">@intestazione;noquote@</h2></br>
      <img align="middle" class="img-circle center-block img-responsive" src="http://images.professionefinanza.com/pfexpo/relatori_portraits/@portrait;noquote@" alt="@intestazione;noquote@" width="10%" height="10%" /></br>
<br></br>
	  @short_cv;noquote@
	    </div>        
